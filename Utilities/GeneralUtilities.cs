namespace UnderwaterGame.Utilities
{
    ...
    public static class GeneralUtilities
    {
        ...
        public static Color MergeColor(Color a, Color b, float amount)
        {
            ...
            return new Color((byte)MathUtilities.Merge(rMin, rMax, amount), (byte)MathUtilities.Merge(gMin, gMax, amount), (byte)MathUtilities.Merge(bMin, bMax, amount), (byte)MathUtilities.Merge(aMin, aMax, amount));
        }
    }
}