namespace UnderwaterGame
{
    ...
    public static class Camera
    {
        ...
        public static void Update()
        {
            ...
            positionTo.X = MathUtilities.Clamp(positionTo.X, GetWidth(), (World.width * Tile.size) - GetWidth());
            positionTo.Y = MathUtilities.Clamp(positionTo.Y, GetHeight(), (World.height * Tile.size) - GetHeight());
            ...
            position.X = MathUtilities.Clamp(position.X, GetWidth(), (World.width * Tile.size) - GetWidth());
            position.Y = MathUtilities.Clamp(position.Y, GetHeight(), (World.height * Tile.size) - GetHeight());
        }
